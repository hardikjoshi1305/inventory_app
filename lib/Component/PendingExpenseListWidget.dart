...
class PendingExpenseListWidget extends StatelessWidget {
  final Datum expenselist;
  String position;

  PendingExpenseListWidget({this.expenselist, this.position});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        bottomtitle(
            100.0, expenselist.userId == null ? "-" : expenselist.userId),
        Container(
          width: 1,
          color: Colors.white,
        ),
        bottomtitle(
            100.0, expenselist.expName == null ? "-" : expenselist.expName),
        Container(
          width: 1,
          color: Colors.white,
        ),

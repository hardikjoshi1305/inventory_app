...
class SendAmountListWidget extends StatelessWidget {
  final Datum expenselist;
  int position;

  SendAmountListWidget({this.expenselist, this.position});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        bottomtitle(
            120.0, expenselist.usename == null ? "-" : expenselist.usename),
        Container(
          width: 1,
          color: Colors.white,
        ),
        bottomtitle(
            100.0, expenselist.remark == null ? "-" : expenselist.remark),
        Container(
          width: 1,
          color: Colors.white,
        ),

...
import '../Views/Inventory/AcceptUpdateInventory.dart';
import '../Views/Inventory/ReturnInventory.dart';

class ReturnInventoryListWidget extends StatelessWidget {
  final Datum UserModel;
  final String usertype;
  ReturnInventoryListWidget({this.UserModel, this.usertype});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        bottomtitle(200.0, this.UserModel.username),
        Container(
          width: 1,
          color: Colors.white,
        ),
            ...
            child: Row(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(1.0),
                  child: IconButton(
                    onPressed: () => Get.to(AcceptUpdateInventory(),
